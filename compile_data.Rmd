...
Map calibrated CO2 data to treatments
```{r co2-map}
# Note that this uses the old file, `auc_norm_date` for testing purposes, which should really be replaced by `auc_calib_date` but the create_std_curve() function is broken right now.
auc_all_calib <- read_csv("output/2022/co2/auc_norm_date")
